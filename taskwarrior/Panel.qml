...
Item {
                            ...
                            ColumnLayout {
                                    ...
                                    Item {
                                        ...
                                        Rectangle {
                                            ...
                                            MouseArea {
                                                ...
                                                onClicked: {
                                                    if (mainInstance)
                                                        mainInstance.completeTask(taskDelegate.uuid);
                                                }
                                            }
                                        }
                                    }
                                ...
                                RowLayout {
                                    ...
                                    NButton {
                                        ...
                                        onClicked: {
                                            if (mainInstance) {
                                                if (taskDelegate.isActive)
                                                    mainInstance.stopTask(taskDelegate.uuid);
                                                else
                                                    mainInstance.startTask(taskDelegate.uuid);
                                            }
                                        }
                                    }
    ...
    function saveDetailChanges() {
        if (!mainInstance || !detailDialog.taskData)
            return;
        ...
        if (detailDialog.editScheduled !== origScheduled)
            modifications.push({
                field: "scheduled",
                value: detailDialog.editScheduled || ""
            });
        ...
        contentItem: ColumnLayout {
            ...
            RowLayout {
                ...
                NButton {
                    ...
                    onClicked: {
                        if (mainInstance)
                            mainInstance.deleteTask(deleteConfirmDialog.deleteUuid);
